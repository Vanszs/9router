  ...
  const proxyDisplayText = boundProxyPool
    ...
    : boundProxyPoolId
      ...
      : hasLegacyProxy
        ...
        : "";
  const autoPingTooltip = autoPing?.provider === "codex" || autoPing?.provider === "antigravity"
    ? `Auto-starts the next 5h ${autoPing.provider === "codex" ? "Codex" : "Antigravity"} window after reset by sending a tiny ping request. Consumes a small amount of quota.`
